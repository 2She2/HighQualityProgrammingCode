namespace Cars.Tests.JustMock.Mocks
{
    ...
    public class MoqCarsRepository : CarRepositoryMock, ICarsRepositoryMock
    {
        protected override void ArrangeCarsRepositoryMock()
        {
            ...
            mockedCarsRepository.Setup(r => r.Search("")).Throws(new ArgumentNullException("Search string must be putted!"));
            ...
            mockedCarsRepository.Setup(r => r.SortedByMake()).Returns(this.FakeCarCollection.OrderBy(c => c.Model).ToList());
